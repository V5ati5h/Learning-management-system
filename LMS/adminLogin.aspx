							...
							<div class="row">
								<div class="col gap-1">
									<div class="form-floating mb-3">
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ControlToValidate="txtadminlogusername"> </asp:RequiredFieldValidator>
									...
									<div class="form-floating mb-3">
										...
										<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtadminlogpassword"> </asp:RequiredFieldValidator>
