<%@ Page Title="" Language="C#" MasterPageFile="~/TeacherDashboard/main.Master" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="LMS.TeacherDashboard.WebForm7" %>
					...
					<div class="card-body">
						<div class="row text-center">
							<h1 class="display-5 fw-bold ls-tight">Regester New
                                    <asp:label ID="Label1" CssClass="text-sucess" runat="server" Text="Faculty"></asp:label>
                                </h1> </div>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="bacicinfo" role="tabpanel" aria-labelledby="bacicinfo-tab">
								<div class="row">
									...
									<div class="col">
										<div class="form-floating mb-3">
											<asp:TextBox CssClass="form-control" ID="txtdept" runat="server" placeholder="Department Number" Enabled="false"></asp:TextBox>
									...
									<div class="col">
										<div class="form-floating mb-3">
											<asp:TextBox CssClass="form-control" ID="txtdeptname" runat="server" placeholder="Department Name" Enabled="false"></asp:TextBox>
						...
						<div class="row form-group ms-5 me-5">
							<asp:Button CssClass="btn btn-success w-20 btn-block btn-lg" ID="Button1" runat="server" Text="UPDATE" OnClick="Button1_Click" /> </div>
					</div>
				</div>
			</div>
		</div>
