<%@ Page Title="" Language="C#" MasterPageFile="~/TeacherDashboard/main.Master" AutoEventWireup="true" CodeBehind="checkAssignemnt.aspx.cs" Inherits="LMS.TeacherDashboard.WebForm12" %>
    ...
    <div class="col">
        <div class="card p-0">
            ...
            <div class="card-body m-0 p-0">
                <asp:GridView ID="gridview" CssClass="table table-striped table-bordered table-sm" runat="server" AutoGenerateColumns="False" DataKeyNames="submitId" AllowPaging="True" OnPageIndexChanging="OnPageIndexChanging" PageSize="25" OnRowDataBound="OnRowDataBound" OnRowEditing="OnRowEditing" OnRowCancelingEdit="OnRowCancelingEdit" OnRowUpdating="OnRowUpdating" OnRowDeleting="OnRowDeleting" EmptyDataText="Select from drop down" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True">
                    <Columns>
                        <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center bg-success text-capitalize text-light" DataField="submitId" HeaderText="submitId" InsertVisible="False" ReadOnly="True" SortExpression="submitId">
                        ...
                        <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center bg-success text-capitalize text-light" DataField="details" HeaderText="details" SortExpression="details">
                            <HeaderStyle CssClass="text-center bg-success text-capitalize text-light"></HeaderStyle>
                        ...
                        <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center bg-success text-capitalize text-light" DataField="submitedOn" HeaderText="submitedOn" SortExpression="submitedOn">
                            <HeaderStyle CssClass="text-center bg-success text-capitalize text-light"></HeaderStyle>

                            <ItemStyle CssClass="text-center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center bg-success text-capitalize text-light" DataField="givenBy" HeaderText="givenBy" SortExpression="givenBy">
                            <HeaderStyle CssClass="text-center bg-success text-capitalize text-light"></HeaderStyle>

                            <ItemStyle CssClass="text-center"></ItemStyle>
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="reply" SortExpression="reply">
                            <EditItemTemplate>
                                <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="replyDD_SelectedIndexChanged" SelectedValue='<%# Eval("reply") %>'>
