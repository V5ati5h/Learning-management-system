<%@ Page Title="" Language="C#" MasterPageFile="~/StudentDashboard/main.Master" AutoEventWireup="true" CodeBehind="examination.aspx.cs" Inherits="LMS.StudentDashboard.WebForm5" %>
				...
				<div class="card text-center">
					...
					<div class="card-body">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="yts" role="tabpanel" aria-labelledby="yts-tab">
								<p>Yet to start</p>
							</div>
