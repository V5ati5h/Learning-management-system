<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard/main.Master" AutoEventWireup="true" CodeBehind="addClass.aspx.cs" Inherits="LMS.AdminDashboard.WebForm9" %>
	...
	<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<asp:GridView ID="Gird" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="1002px" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
			...
			<Columns>
				<asp:BoundField DataField="classID" HeaderText="Did" InsertVisible="False" ReadOnly="True" SortExpression="classID" />
				<asp:BoundField DataField="className" HeaderText="Dname" SortExpression="Dname" />
				<asp:BoundField DataField="departID" HeaderText="departID" SortExpression="Dname" />
		...
		<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LSMConnectionString %>" SelectCommand="SELECT * FROM [Tbl_Class]" UpdateCommand="UPDATE [Tbl_Class] SET [className]=@className, [departID]=@departID, [CreatedDate]=@CreatedDate WHERE [classID]=@classID" DeleteCommand="DELETE [classID] WHERE [classID]=@classID"></asp:SqlDataSource>
	</asp:Content>