<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard/main.Master" AutoEventWireup="true" CodeBehind="notice.aspx.cs" Inherits="LMS.AdminDashboard.WebForm14" %>
    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="card text-center">
                <div class="card-header text-light bg-danger fw-bold p-2">Add Notice</div>
                <div class="card-body">
                    <div class="row">
                        <div class="col gap-1">
                            ...
                            <div class="row form-group ms-5 me-5 gap-1">
                                <asp:Button CssClass="btn btn-danger w-20 btn-block btn-lg" ID="ClassSubmit" runat="server" Text="Save" OnClick="ClassSubmit_Click" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card p-0">
                ...
                <div class="card-body m-0 p-0">
                    <asp:GridView ID="gridview" CssClass="table table-striped table-bordered table-sm" runat="server" AutoGenerateColumns="False" DataKeyNames="noticeID" AllowPaging="True" OnPageIndexChanging="OnPageIndexChanging" PageSize="25" OnRowDataBound="OnRowDataBound" OnRowEditing="OnRowEditing" OnRowCancelingEdit="OnRowCancelingEdit" OnRowUpdating="OnRowUpdating" OnRowDeleting="OnRowDeleting" EmptyDataText="Select from drop down" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true">
                            <Columns>
                            <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center bg-danger text-capitalize text-light" DataField="noticeID" HeaderText="noticeID" InsertVisible="False" ReadOnly="True" SortExpression="noticeID" />
                            <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center bg-danger text-capitalize text-light" DataField="title" HeaderText="title" SortExpression="title" />
                            ...
                            <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center bg-danger text-capitalize text-light" DataField="byStaff" HeaderText="byStaff" SortExpression="byStaff" />
                            <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center bg-danger text-capitalize text-light" DataField="date" HeaderText="date" SortExpression="date" />
