			...
			<div class="row">
				<div class="card p-0">
					...
					<div class="card-body m-0">
                        ...
                        <asp:GridView ID="Gird" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="Gird_SelectedIndexChanged" Width="1055px" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Fid">
                            <Columns>
                                <asp:BoundField DataField="Fid" HeaderText="Fid" SortExpression="Fid" InsertVisible="False" ReadOnly="True" />
					    ...
					    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LSMConnectionString %>" SelectCommand="SELECT * FROM [Tbl_Faculty]" UpdateCommand="UPDATE [Tbl_Faculty] SET [Fname]=@Fname, [Mname]=@Mname, [Lname]=@Lname, [Mobile]=@Mobile, [Email]=@Email, [Username]=@Username, [Password]=@Password, [Did]=@Did, [deptname]=@deptname WHERE [Fid]=@Fid" DeleteCommand="DELETE FROM [Tbl_Faculty] WHERE [Fid]=@Fid"></asp:SqlDataSource>
					</div>
				</div>
			</div>
		</div>
