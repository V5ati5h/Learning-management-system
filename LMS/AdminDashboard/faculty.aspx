			...
			<div class="row">
				<div class="card p-0">
					...
					<div class="card-body m-0">
                        ...
                        <asp:GridView ID="Gird" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource2" OnSelectedIndexChanged="Gird_SelectedIndexChanged" Width="1055px" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Fid">
                            <Columns>
					    ...
					    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:LSMConnectionString3 %>" SelectCommand="SELECT * FROM [Tbl_Faculty]"></asp:SqlDataSource>
					</div>
				</div>
			</div>
		</div>
