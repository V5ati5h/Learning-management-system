<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="LSM.WebForm2" %>
    ...
    <!-- imgCarousel starts-->
        ...
        <div id="imgCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner header-carousel">
                <div class="carousel-item owl-carousel-item active">
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-sm-10 col-lg-8">
                                    ...
                                    <p class="fs-5 text-white mb-4 pb-2">Some text over here..</p>
              ...
              <div class="carousel-item owl-carousel-item">
                <img class="img-fluid d-block w-100" src="img/carousel-2.jpg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute scard w-100 h-100" src="img/carousel-1.jpg" alt="" style="object-fit: cover;">
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="course-item bg-light scard">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid scard" src="img/course-1.jpg" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="course-item bg-light scard">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid scard" src="img/course-2.jpg" alt="">
                                <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                    <a href="#" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
                                    <a href="#" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Join Now</a>
                                </div>
                            ...
                            <div class="d-flex border-top">
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>3 Years</small>
                                <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>120 Students</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row m-0" style="justify-content: center; gap:1rem;">
                <div class="card col-md-3 col-12">
                    <div class="card-content">
                        <div class="card-body">
                            <img class="img " src="img/testimonial-1.jpg" />
                ...
                <div class="card col-md-3 col-12 ml-2">
                    <div class="card-content">
                        <div class="card-body">
                            <img class="img" src="img/testimonial-2.jpg" />
                ...
                <div class="card col-md-3 col-12 ml-2">
                    <div class="card-content">
                        <div class="card-body">
                            <img class="img rck" src="img/testimonial-3.jpg" />
